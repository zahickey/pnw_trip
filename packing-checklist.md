...
## Climbing gear
- [ ] Trad rack (cams to at least a #3, full set of nuts) — Squamish and Yosemite both want a deep rack for splitters and cracks
- [ ] Double ropes or single + tag line for multi-pitch rappels
- [ ] Sport quickdraws (12+) for Smith Rock
- [ ] Helmet, harness, belay device, personal anchor system
- [ ] Approach shoes + climbing shoes
- [ ] Guidebooks or offline topo access for: Joshua Tree, Tuolumne, Smith Rock, Squamish

## Camper / power systems
- [ ] EcoFlow Delta 3 — fully charged before departure, confirm solar input wiring is finished
- [ ] Verify roof vent seal (ABS/polycarbonate cut + electrical splice) is weathertight before the first rain
- [ ] Spare fuses / electrical splice kit in case of in-transit repairs
- [ ] Torklift tie-downs — recheck torque before departure and again after the first few hundred miles
- [ ] Propane (check levels, bring a spare canister for the BC/Yukon stretch where refills are sparser)
